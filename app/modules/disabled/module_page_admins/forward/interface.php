        ...
        <div class="card">
            ...
            <table class="table table-hover">
                ...
                <?php for ( $i = 0, $sz = sizeof( $res ); $i < $sz; $i++ ): $General->get_js_relevance_avatar( $General->arr_general['only_steam_64'] === 1 ? con_steam32to64( $res[ $i ]['authid'] ) : $res[ $i ]['authid'] )?>
                    <tr class="pointer" onclick="location.href = '<?php echo sprintf('%s/profiles/%s/0', $General->arr_general['site'], $General->arr_general['only_steam_64'] === 1 ? con_steam32to64( $res[ $i ]['authid'] ) : $res[ $i ]['authid'] )?>';">
